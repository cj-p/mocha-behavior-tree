...
import { TestObject } from './misc/TestObject'

const expect = chai.expect

describe('test TestObject',
    given('create Obj', () => ({ obj: new TestObject() }),
        when('add 1', async ({ obj }) => {
                await obj.add(1)
            },
            and('add 1', ({ obj }) => obj.add(1).then(values => ({ obj, values })),
        ...
        when('add 2', async ({ obj }) => {
            ...
            and('add 1', ({ obj }) => {
                ...
                then('result equals to 2-1', ({ obj, a }) => {
